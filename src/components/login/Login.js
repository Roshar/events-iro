        ...
        <div className="registration__form register">
          <div className="register__block">
            ...
            <input
              ...
              type="text"
              name="login"
              aria-labelledby="surname_i"
              aria-describedby="danger-login"
              aria-required="true"
              required
          ...
          <div className="register__block">
            <label className="register__label" htmlFor="name_i" id="name_l">
              <span className="register__required">*</span> Пароль:{" "}
            </label>
            <input
              className="register__input"
              id="password_i"
              type="password"
              name="password"
              aria-labelledby="name_i"
              aria-describedby="danger-name"
              aria-required="true"
              required
              onChange={handleChange}
            />
          ...
          <button className="register__btn btn" type="submit" onClick={onClick}>
            Войти
          </button>
