...
const SpeakerPageEdit = () => {
  ...
  const submitFunc = async (e) => {
    ...
    if (errorCount.length < 1) {
      ...
      const { data } = await axios.post(
        `${process.env.REACT_APP_BASE_URL}/admin/speaker/edit/${id}`,
        formData,
        {
          headers: {
  ...
  const submitFuncDel = async (e) => {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BASE_URL}/admin/speaker/delete/${id}`,
      checkAdminRole()
    );
  ...
  const getSpeakerPageEdit = async () => {
    ...
    if (data.code === 403) {
      ...
      setFile(
        `${process.env.REACT_APP_BASE_IMG_URL}/avatars/${data[0]["avatar"]}`
      );
    }
  };
        ...
        <div className="container--personal-card">
          ...
          <div className="personal_card">
            ...
            <div className="personal_card__main_info">
              ...
              <div className="personal_card__block_submit">
                <button
                  className="personal_card__btn btn btn--del"
